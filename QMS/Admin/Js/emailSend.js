document.addEventListener('DOMContentLoaded', () => {
    ...
    submit.addEventListener('submit', (e) => {
        ...
        Email.send({
            ...
            To: senderEmail,
            Subject: "Quiz Link",
            Body: "This is your test link: " + "http://localhost/QMS-tally/student/Html/studentLoginPage.php?id=" + selectedValue + "&uniqueId=" + randomNumber + "&emailId=" + senderEmail + 'Email ID: ${senderEmail}\nUnique Email ID: ${randomNumber}'
