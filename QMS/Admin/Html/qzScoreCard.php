                ...
                <div class="tableOverFlow">
                    <table id="quizTable">
                        ...
                        <?php
                            ...
                            $query2 =  "SELECT * FROM result WHERE quizName = '$quizName' AND quizStartTime = '$quizStartTime' AND adminEmail = '$adminEmail'";
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['correctQues']?></td>
                            <td><?php echo $row['wrongQues']?></td>
