    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="showEditQuizs.php"><i class="fas fa-edit"></i>Show/Edit Quizes</a></li>
                        ...
                        <div class="question-row">
                            ...
                            <div class="rowFlex">
                                <div class="row">
                                    ...
                                    <input type="text" class="questions" name="option" placeholder="Enter option A"
                                        required autocomplete="off">
                                </div>
                                <div class="row">
                                    <label>Option B</label>
                                    <input type="text" class="option" name="option" placeholder="Enter option B"
                                        required autocomplete="off">
                                </div>
                                <div class="row">
                                    <label>Option C</label>
                                    <input type="text" class="option" name="option" placeholder="Enter option C"
                                        required autocomplete="off">
                                </div>
                                <div class="row">
                                    <label>Option D</label>
                                    <input type="text" class="option select" name="option" placeholder="Enter option D"
                                        required autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
