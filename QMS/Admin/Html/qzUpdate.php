...
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="edit-btn" >
                                <a href="quizEditPage.php?id=<?php echo $row['id'];?>" style="color:white;"
                                    class="btn edit-link" data-toggle="tooltip" data-placement="top"
                                    title="EDIT" onclick="return dateCheckEdit('<?php echo $row['quizStartTime']; ?>')">EDIT</a>
                            </button>
                        </td>
                        <td>
                            <button class="delete-btn" >
                                <a href="delQzConfi.php?id=<?php echo $row['id'];?>" style="color:white;"
                                    class="btn delete-link" data-toggle="tooltip" data-placement="top"
                                    title="DELETE" onclick="return dateCheckDelete('<?php echo $row['quizStartTime']; ?>')">DELETE</a>
                            </button>
                        </td>
                    </tr>
                    <?php
    ...
    <script>
        function dateCheckEdit(quizStartTime){
            ...
            alert('Quiz Time has passed. Editing is not allowed.!');
            return false;
        }

        function dateCheckDelete(quizStartTime){
            var givenDate = new Date(quizStartTime);
            console.log(givenDate);
            var currentDate = new Date();
            if (givenDate > currentDate) {
            ...
            alert('Quiz Time has passed. Delete Operation is not allowed.!');
            return false;
        }
